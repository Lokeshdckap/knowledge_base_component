...
import { PageDeleteConfirmation } from "../commonComponents/PageDeleteConfirmation";
        ...
        >
          <div className="flex  items-center relative space-x-2 mt-8">
            ...
            <div className="flex justify-between items-center">
              ...
              />
              <div>
                <Button className="ml-20" onClick={props.clickPublish}>
                  Save this Page
                </Button>
              </div>
            </div>
