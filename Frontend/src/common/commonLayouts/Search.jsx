...
export const Search = (props) => {
    ...
    console.log(props.searchInpRef);
  ...
  return (
    <div>
      ...
      <div className=" absolute left-0 top-0 z-20 ">
        <div className="bg-[#fff] max-h-[600px] w-[600px] ml-[380px] mt-[60px] rounded-lg -z-10" ref={searchRef}>
          ...
          <div className="max-h-[320px] overflow-auto pt-3 pb-6">
            {props.searchData ? (
              props.searchData.map((search) => (
                <div className="flex justify-between items-center w-[550px] p-2 rounded m-auto hover:bg-sky-100 cursor-pointer" 
