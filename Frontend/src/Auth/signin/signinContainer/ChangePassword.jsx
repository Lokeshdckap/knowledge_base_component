...
export default function ChangePassword() {
  ...
  const resetPassword = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      axiosClient
        .post(
          `/api/auth/resetPassword/${params.uuid}/${params.token}`,
          newPassword
        )
    ...
    <main className="flex">
      <div className="bg-secondary h-[664px] w-1/2 p-20">
        <div className="space-y-2">
          ...
          <h2 className="text-base text-textPrimary">
        ...
        <form className="space-y-2 pt-3" action="#" method="POST">
          <div className="relative">
            <label htmlFor="password" className="text-textPrimary text-base	">
            ...
            <div className="mt-1">
              ...
              <div className="">
                {PasswordVisible ? (
                  <span
                    className="material-symbols-outlined absolute right-28 top-10 cursor-pointer text-gray-500 text-xl"
            ...
            <div className="mt-2 relative">
              ...
              <div className="">
                {ConfirmPasswordVisible ? (
                  <span
                    className="material-symbols-outlined absolute right-28 top-2 cursor-pointer text-gray-500 text-xl"
