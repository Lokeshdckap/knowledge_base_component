...
Team.hasMany(Batch, { foreignKey: 'uuid' });

Batch.belongsTo(Team, { foreignKey: "team_uuid" });

Team.hasMany(Script, { foreignKey: 'uuid' });

Script.belongsTo(Team, {foreignKey: 'team_uuid'});

Batch.hasMany(Script, { foreignKey: "uuid" })

Script.belongsTo(Batch, {foreignKey: 'batch_uuid'});
    ...
    if (teamExists) {
      ...
      if (newTeam) {
        ...
        return res.status(500).send({
          Error: "Error Team Not Created else",
        });
      }
    }
  } catch (err) {
